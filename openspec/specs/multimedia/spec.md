...
La pestaña Multimedia SHALL ser un **explorador de ficheros** en rejilla de miniaturas (carpetas, vídeos, imágenes). Esta/próxima semana se muestran como carpetas de imagen y vídeo en `week/`. El árbol izquierdo SHALL incluir Home y Desktop. Seleccionar un fichero lo deja en el panel; Show proyecta. Una imagen en el auditorio MUST conservar proporción (letterbox). El outline vive en Cronómetro.
