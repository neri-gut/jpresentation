...
Desarrollo dirigido por specs: [`openspec/INDEX.md`](openspec/INDEX.md). Change de código actual: [`037-contain-plantillas`](openspec/changes/037-contain-plantillas/). `001` y `029`–`036` cerrados.
...
## Fuera de alcance (v1 / change 037)
