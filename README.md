...
8. **Configuración → idioma de la app y de contenido**: el de contenido lista la semilla (p. ej. `S`, `TG`) y es el que usa «Obtener guía»; no hay petición de red. No hay menú Idiomas en la barra.
